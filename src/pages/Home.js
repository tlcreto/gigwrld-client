  ...
  return (
    <div className="min-h-screen">
      ...
      <div 
        ...
        style={{
          backgroundImage: 'url("/images/claudio-schwarz-4H9xt2DNgNc-unsplash.jpg")'
        }}
      >
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 text-center">
          <h1 className="text-5xl md:text-7xl font-bold text-white mb-6 animate-fade-in-down drop-shadow-2xl">
            Welcome to{" "}
            <span className="bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">
              GigWrld
            </span>
          </h1>
          <p className="text-xl md:text-2xl text-white mb-8 max-w-3xl mx-auto animate-fade-in-up drop-shadow-lg leading-relaxed">
          ...
          <div className="animate-fade-in-up" style={{ animationDelay: "400ms" }}>
            {user ? (
              <div className="space-y-6">
                <p className="text-xl text-green-300 font-semibold drop-shadow-md">
                  Welcome back! Ready to explore gigs? 🎉
                </p>
                <Link 
                  to="/dashboard" 
                  className="inline-block bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white font-semibold px-8 py-4 rounded-full shadow-2xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300 border-2 border-white/20"
                >
                  Go to Dashboard →
                </Link>
              </div>
              ...
              <div className="space-y-6">
                <div className="space-x-4">
                  <Link 
                    to="/register" 
                    className="bg-gradient-to-r from-blue-500 to-purple-600 hover:from-blue-600 hover:to-purple-700 text-white font-semibold px-8 py-4 rounded-full shadow-2xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300 border-2 border-white/20"
                  >
                    Get Started
                  </Link>
                  <Link 
                    to="/browse-gigs" 
                    className="border-2 border-white text-white hover:bg-white/20 font-semibold px-8 py-4 rounded-full shadow-2xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300 backdrop-blur-sm"
                  >
                    Browse Gigs
                  </Link>
                </div>
                <div className="pt-6">
                  <p className="text-white/90 mb-4 drop-shadow-md">Already have an account?</p>
                  <Link 
                    to="/login" 
                    className="text-white hover:text-blue-200 font-semibold text-lg border-b-2 border-white/50 hover:border-white transition-all duration-300"
                  >
                    Sign In
                  </Link>
                </div>
